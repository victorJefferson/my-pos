...
export default function Sidebar() {
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-white dark:bg-[#0a0a14] border-r border-slate-200 dark:border-white/5 shrink-0 transition-colors duration-200">
      ...
      <div className="px-5 py-4 border-b border-slate-200 dark:border-white/5 relative">
      ...
      <div className="px-4 py-4 border-t border-slate-200 dark:border-white/5 flex items-center gap-3">
        <UserButton
          appearance={{
            elements: {
